...
exports.servertoken = 'CgnAHEIRLkdc';
/**
...
exports.special = ['Soulamorten','pokem9n','todorokidelta'];
...
//tell rank - set it to true if you want tell rank to be enabled.
exports.tellrank = true;
