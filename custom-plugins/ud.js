		...
		function callback(error, response, body) {
			if (!error && response.statusCode === 200) {
				...
				if (page['result_type'] === 'no_results') {
					...
					let output = "<details><summary><b>This may contain NSFW content. Viewer's discretion advised.</b></summary><br><b>" + Chat.escapeHTML(definitions[0]['word']) + ":</b><br><br> " + Chat.escapeHTML(definitions[0]['definition']).replace(/\r\n/g, '<br />').replace(/\n/g, ' ') + "</details>";
