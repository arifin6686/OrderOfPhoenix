...
exports.commands = {
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#0066ff><u>" + serverName + " Credits</b></u></font><br />" +
			...
			"- " + Server.nameColor('Pokem9n', true) + " (Owner, System Operator, Policy Admin, Development)<br />" +
			 "<br />" + Server.nameColor('Todorokidelta', true) + " (Owner, System Operator, Development, CSS)<br />" +
			"<u><b>Contributors:</b></u><br />" +
			"- " + Server.nameColor('Arifin', true) + " (Server Admin, Development, Roomintros)<br />" +
      "- " + Server.nameColor('YouAresoAwesome', true) + " (leader, policy admin)<br />" +
